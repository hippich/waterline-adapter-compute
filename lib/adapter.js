...
var adapter = {
  ...
  find: function (connection, collection, options, cb) {
    var model = sails.models[collection];
    var def = model.attributes;
    var args = options.where;
    var results = [];

    adapter.objectProduct(args).forEach(function(args) {
      var result = {};
      var data = {};
      ...
      Object.keys(def).forEach(function(key) {
        ...
        else if (def[key].find) {
          value = def[key].find.apply(this, [args, data]);
        }
